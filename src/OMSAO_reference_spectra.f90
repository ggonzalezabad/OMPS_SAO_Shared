MODULE OMSAO_reference_spectra

  USE OMSAO_precision_module, ONLY: i4, r8
  USE OMSAO_indices_module, ONLY: max_rs_idx, pge_static_input_luns, &
       comm_idx, ring_idx
  USE OMSAO_parameters_module, ONLY: zerospec_string, maxchlen, &
       max_spec_pts
  ...
  USE OMSAO_errstat_module, ONLY: pge_errstat_ok, pge_errstat_warning, pge_errstat_error, &
       error_check, vb_lev_stmdebug, vb_lev_default, omsao_s_read_refspec_file, &
       omsao_e_read_refspec_file, omsao_e_open_refspec_file, omsao_e_refspec_maxpts, &
       omsao_w_close_refspec_file, pgs_smf_mask_lev_s, pgsd_io_gen_rseqfrm, file_read_ok, f_sep
...
SUBROUTINE read_reference_spectra ( n_max_rspec, pge_error_status )
...
END MODULE OMSAO_reference_spectra
